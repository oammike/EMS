...
class CampaignController extends Controller
{
    ...
    public function orgChart()
    {
      ...
      if ($this->user->userType_id == '4') return view('access-denied');
        ...
        //$teamBen = $benTree; return $benTree;
        ...
        V: "#9f80a8","#7e43b1","#70025d","#673888"*/
          ...
          return view('people.campaigns-orgChart',compact('colorAssignment','myTree','henrys','teamHenry','teamLisa','teamJoy','joys', 'lisas','user4', 'user3', 'user2','canDelete','canUpdateLeaves','mySubordinates','leadershipcheck','user'));
