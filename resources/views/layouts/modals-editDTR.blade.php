<div class="modal fade" id="editCWS{{$modelID}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        
          <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
          <h4 class="modal-title text-success" id="myModalLabel"><i class="fa fa-clock-o"></i> Modify DTR</h4>
      ...
      <input type="hidden" name="TLsubmitted" value="1" />
      ...
      <div class="modal-body-upload" style="padding:20px;">
        ...
        <br/><br/>
         ...
         <h5 class='text-center'>Change employee's work schedule for<br/><br/> <br/><strong class="text-danger">{{ $Dday }} {{ $DproductionDate }} </strong><br/>from: {{$data['shiftStart']}} - {{$data['shiftEnd']}} 
          <br/><br/>to: </h5>
              ...
              <div class="col-sm-6">
                  ...
                  <select name="timeEnd" class="end form-control" style="margin-bottom:5px"><option value="0">* Select shift *</option>';
                    ...
                    @foreach ($shifts as $shift)
                        @if( $shift !== $data['shiftStart']." - ".$data['shiftEnd'])
