      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview @if ( Request::is('survey*') ) active @endif">
          ...
          <ul class="treeview-menu">
            ...
            <li @if (Request::is('survey*')) class="active" @endif style="padding-left:20px"><a href="{{ action('SurveyController@show',3)}}"><i class="fa fa-beer"></i> Year End Party Theme <span class="label label-success" style="font-size:0.5em; margin-left:5px; margin-bottom: -5px"><strong> New! </strong></span></a> </li>
         ...
         <li class="treeview @if ( Request::is('gallery') ) active @endif">
          ...
          <ul class="treeview-menu">
            ...
            <li @if (Request::is('gallery')) class="active" @endif style="padding-left:20px"><a href="{{ action('HomeController@gallery',['a'=>7]) }}"><i class="fa fa-beer"></i> Happy Hour <span class="label label-success" style="font-size:0.5em; margin-left:5px; margin-bottom: -5px"><strong> New! </strong></span></a> </li>
