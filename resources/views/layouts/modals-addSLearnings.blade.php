<div class="modal fade" id="myModal_addSLearning{{$modelID}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
     ...
     <div class="modal-content">
      ...
      <div class="modal-body">{{ Form::open(['route' => [$modelRoute, $modelID], 'method'=>$modalTitle, 'id'=> $formID ]) }} 
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <?php $today = date('Y'); ?>
            <select class="form-control" name="periodSLearn" id="periodSLearn">
              <option value="0">* select date *</option>
              @foreach($slUpdates_periods as $p)
         ...
         <div class="row" style="padding-top: 20px">
          ...
          <div class="col-lg-3" id="periods">
            @foreach($slUpdates as $u)

            <label class="p_{{$u->period}}" style="display: none"><input type="radio" value="{{$u->id}}" name="slupdate_id" /> &nbsp;{{$u->credits}}&nbsp;&nbsp; </label>
