<div class="modal fade" id="myModal_addVL{{$modelID}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
     ...
     <div class="modal-content">
      ...
      <div class="modal-body">{{ Form::open(['route' => [$modelRoute, $modelID], 'method'=>$modalTitle, 'id'=> $formID ]) }} 
        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-default"><p>For the Year: </p>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-default">Total Earned Credits for this year:<br/><small>(including leaves carried over from last year)</small></div> 
          <div class="col-lg-3"><input style="margin-top: 5px" class="form-control" required="required" type="text" name="beginBalance" placeholder="0.00" /><br/><br/></div>
          <div class="col-lg-2">&nbsp;</div>
        </div>

        <div class="row">
          <div class="col-lg-2">&nbsp;</div>
          <div class="col-lg-5 text-default">Total Credits Used<br/><small>within this year</small>:</div> 
