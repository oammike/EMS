            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-md-4">
                  ...
                  <h1 style="margin-top: 55px; padding:25px; background:rgba(154,245,38,0.5); color:#666" class="text-center">eNPS : <strong style="color: #000">{{number_format(  ( count($promoters)/count($surveyData) )*100  -  ( count($detractors)/count($surveyData) )*100 ) }} </strong><span style="font-size: 0.5em;"></span> </h1>
                </div>
                <!-- /.col -->
              </div>
              <!-- /.row -->
