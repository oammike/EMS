          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-sm-6 col-xs-12">
               <!-- Widget: user widget style 1 -->
                          ...
                          -->
                            <div class="widget-user-header  @if ($doneEval[$employee['data']->id]['evaluated'] && ($employee['data']->userType_id == '4') ) bg-gray @elseif ($doneEval[$employee['data']->id]['evaluated'] && ($employee['data']->userType_id !== '4') ) bg-black @elseif (!$doneEval[$employee['data']->id]['evaluated'] && ($employee['data']->userType_id !== '4') )bg-darkgreen  @else bg-green @endif">
