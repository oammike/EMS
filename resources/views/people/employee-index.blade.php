    ...
    $("#active").DataTable({
                      ...
                      "columns": [
                            ...
                            if(full.has2316){
                              ...
                              var has2316 = '<br/><br/><a href="user_forms/create?for='+data+'"   style="margin:3px" class="btn btn-xs btn-success"><i class="fa fa-upload"></i> Upload Digital Forms</a> <br/>';

                            }

                            if(full.hasSigned2316=='1') {
                              var bir = has2316+'<a target="_blank" href="viewUserForm?s=1&f=BIR2316&u='+data+'" style="margin:3px" class="btn btn-xs btn-danger"><i class="fa fa-download"></i> Download Signed 2316</a> <br/><a data-toggle="modal" data-target="#myBIRModal'+full.id+'"  class="btn btn-xs btn-warning"><i class="fa fa-trash"></i> Delete Signed Form</a>';
                            ...
                            @else
                                ...
                                return '<a target="_blank" href="user_vl/showCredits/'+data+'" class="btn btn-xs btn-default" style="margin:2px"><i class="fa fa-bar-chart"></i>  Leave Credits</a><a target="_blank" href="user/'+data+'/createSchedule" class="btn btn-xs btn-default" style="margin:3px"><i class="fa fa-clock-o"></i>  Plot Sched</a><a target="_blank" href="movement/changePersonnel/'+data+'" id="teamMovement'+data+'" memberID="'+data+'" class="teamMovement btn btn-xs btn-default" style="margin:3px"><i class="fa fa-exchange"></i> Movement</a> <a target="_blank" href="userRequests/'+data+'" class="btn btn-xs btn-default" style="margin:3px"><i class="fa fa-clipboard"></i> View Requests</a> <a target="_blank" href="user_dtr/'+data+'"   style="margin:3px" class="btn btn-xs btn-primary"><i class="fa fa-calendar"></i> View DTR</a>'+modalcode;
