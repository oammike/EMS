                            ...
                            <tr>
                              <td>
                                ...
                                @else
                                  ...
                                  <h5 style="line-height:0.8em"> {{$employee->lastname }}, {{$employee->firstname}} </h5>
                                 ...
                                 <p style="font-size:0.7em"><br/>Date Hired: <small>{{ date_format(date_create($employee->dateHired), "M d, Y")  }} </small> <br/>
                                  Date Evaluated: <small>{{date_format(date_create($evalForm->created_at),"M d, Y") }} </small> <br/>
                                    ...
                                    <tr>
                                      <td valign="top" width="45%">
                                        ...
                                        <!-- <table style="margin: 0 auto; font-size:0.6em; font-family:'Roboto', Arial, sans-serif; border:1px dotted #666; left-padding:15px" width="80%" cellpadding="1">
                                          ...
                                          <tr>
                                            <td @if ($evalForm->overAllScore <= 100.0 && $evalForm->overAllScore >= 97.50) style="background-color:#dedede" @endif>&nbsp;&nbsp;&nbsp;100 - 97.5</td>
                                            <td @if ($evalForm->overAllScore <= 100.0 && $evalForm->overAllScore >= 97.50) style="background-color:#dedede" @endif align="center">5%</td>
                                            
                                          </tr>
                                          <tr>
                                            <td @if ($evalForm->overAllScore <= 97.49 && $evalForm->overAllScore >= 89.50) style="background-color:#dedede" @endif>&nbsp;&nbsp;&nbsp;97.4 - 89.5</td>
                                            <td  @if ($evalForm->overAllScore <= 97.49 && $evalForm->overAllScore >= 89.50) style="background-color:#dedede" @endif align="center">4%</td>
                                          </tr>

                                          <tr style="border:1px dotted #67aa08">
                                            <td @if ($evalForm->overAllScore <= 89.49 && $evalForm->overAllScore >= 84.50) style="background-color:#dedede" @endif>&nbsp;&nbsp;&nbsp;89.4 - 84.5</td>
                                            <td @if ($evalForm->overAllScore <= 89.49 && $evalForm->overAllScore >= 84.50) style="background-color:#dedede" @endif align="center">3%</td>
                                          </tr>

                                          <tr>
                                            <td @if ($evalForm->overAllScore <= 84.49 && $evalForm->overAllScore >= 80.0) style="background-color:#dedede" @endif>&nbsp;&nbsp;&nbsp;84.4 - 80.0</td>
                                            <td @if ($evalForm->overAllScore <= 84.49 && $evalForm->overAllScore >= 80.0) style="background-color:#dedede" @endif align="center">2%</td>
                                          </tr>

                                          <tr>
                                            <td @if ($evalForm->overAllScore <= 79.99 && $evalForm->overAllScore >= 70.0) style="background-color:#dedede" @endif>&nbsp;&nbsp;&nbsp;79.9 - 70.0</td>
                                            <td @if ($evalForm->overAllScore <= 79.99 && $evalForm->overAllScore >= 70.0) style="background-color:#dedede" @endif align="center">1%</td>
                                          </tr>

                                          <tr>
                                            <td @if ($evalForm->overAllScore <= 69.99 ) style="background-color:#dedede" @endif>&nbsp;&nbsp;&nbsp;69.9 below</td>
                                            <td @if ($evalForm->overAllScore <= 69.99 ) style="background-color:#dedede" @endif  align="center">none</td>
                                          </tr>
                                             ...
                                             @else
                                                ...
                                                <!-- ******** collapsible box ********** -->
                                                      <div class="box box-default " style="padding-top:-10px">
                                                        ...
                                                        <table class="table">
                                                              <tr>
                                                                ...
                                                                <td class="text-center "><h5 class="scores" value="0"><?php echo  ( number_format(((($entry['percentage']*$entry['rating']->label)/100)/2.65)*100,2) );?></h5></td>
                                                                @else

                                                                <td class="text-center "><h5 class="scores" value="0"><?php echo  ( number_format(((($entry['percentage']*$entry['rating']->label)/100)/5)*100,2) );?></h5></td>
                                                                ...
                                                                <td class="text-center text-danger"><h5>{{$entry['rating']->label}}</h5>
                                                      ...
                                                      <div class="box-body">                                                        
                                                        ...
                                                        <div style="color:gray; font-size:0.6em; padding-bottom:-20px; line-height:0.8em">

                                                           @if (!empty($entry['value']))
                                                                    <label >{{$entry['attribute']}}</label><br /><p style="font-style:italic; padding-top:5px">{{$entry['value']}}</p>
                                                                   
                                                                    @endif

                                                                     @if (!empty($formEntries[$cnt+1]['value']))

                                                                     <br/><label >{{$formEntries[$cnt+1]['attribute']}}</label><br/><p style="font-style:italic; padding-top:5px">{{$formEntries[$cnt+1]['value']}}</p>
                                                                    <br/>
                                                                    @endif
                                        ...
                                        @if ( $summary['columns'] !== null)
                                          ...
                                          <tr>
                                             @foreach ($summary['columns'] as $col)
                                               ...
                                               @if (!empty($performanceSummary[$indexCtr]) || $performanceSummary[$indexCtr]!== '   ' || $performanceSummary[$indexCtr] !== '')
                                            <td style="padding:5px"><em>{{$performanceSummary[$indexCtr]}}<p>&nbsp;</p></em></td>
                                              @endif
                                            <?php $indexCtr++;?>
                                ...
                                <table border="0" width="100%">
                                  ...
                                  Date : </p>
                                    ...
                                    <td>
                                      ...
                                      @if ( file_exists('public/img/employees/'.$evaluatorData->id.'-sign.png') )
                                       <p style="font-size:0.8em"><br/>
                                  Evaluator :<br/>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br/><?php /*<img width="150" src="{{asset('public/img/employees/'.$evaluatorData->id.'-sign.png')}}" style="margin-bottom:-20px" / */ ?><br/> _____________________________
