                        ...
                        <div class="nav-tabs-custom">
                          <ul class="nav nav-tabs">
                            ...
                            <li><a href="{{action('EvalFormController@allPendings',['type'=>6])}}">
                              ...
                              <li @if($type==6) class="active" @endif><a href="{{action('EvalFormController@allApproved',['type'=>6])}}">
                               <strong  @if($type==6) class="text-success" @else class="text-default" @endif><i class="fa fa-check"></i> Approved<br/> <small>evaluations</small></strong></a> </li>
  ...
  $(function () {
   ...
   @if($type==6) //2020 annual
      $("#teams").DataTable({
                    ...
                    //   $('#ct1').html(allItems);
                    // },
                   "ajax": "{{ action('EvalFormController@getAllApprovedEvals',['type'=>$type])}}",
                    ...
                    "columns": [
                        ...
                        modalcode += '</div>';
                          ...
                          if(full.isFinalEval=='1')
                            ...
                            return '<a target="_blank" href="./evalForm/'+full.id+'" class="btn btn-xs btn-default"  style="margin-top:5px" ><i class="fa fa-search"></i> View</a><a href="#"  style="margin-top:5px" class="btn btn-xs btn btn-default" data-toggle="modal" data-target="#myModal'+full.id+'"><i class="fa fa-trash"></i> Delete</a><a href="./evalForm/print/'+full.id+'" target="_blank" class="btn btn-xs btn-default" style="margin-top:5px"><i class="fa fa-print"></i> Print PDF </a><div class="clearfix"></div><h4> -----</h4><a data-toggle="modal" data-target="#myModal3'+full.id+'" class="btn btn-sm btn-danger"><i class="fa fa-thumbs-down"></i> Reject</a><a class="btn btn-sm btn-success" style="margin:2px" data-toggle="modal" data-target="#myModal2'+full.id+'"><i class="fa fa-thumbs-up"></i> Mark as Final</a>'+modalcode;
