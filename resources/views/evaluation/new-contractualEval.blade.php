...
@section('metatags')
<title>New Contractual Evaluation | OAMPI Evaluation System</title>
<style type="text/css">
a.back-to-top {
  display: none;
  width: 60px;
                          ...
                          <div class="box box-widget widget-user-2">
                            ...
                            <div class="widget-user-header  @if ($employee->userType_id == '3')  bg-gray @else bg-green @endif">
                              ...
                              <div class="widget-user-image">
                                ...
                                <a href="{{action('UserController@show', $employee->id)}}" target="_blank"><img src="{{asset('public/img/employees/'.$employee->id.'.jpg')}}" class="img-circle pull-left" alt="User Image" width="70"></a>
                                @else
                                 <a href="{{action('UserController@show', $employee->id)}}" target="_blank"> <img width="70" src="{{asset('public/img/useravatar.png')}}" class="user-image pull-left" alt="Employee Image" /></a>
                      ...
                      <div class="box-body">
                        <div class="row">
                          <div class="col-lg-8">
                            ...
                            <p> Contractual Evaluation guidelines go here... </p>
