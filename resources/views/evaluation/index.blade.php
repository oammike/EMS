      ...
      $("#teams").DataTable({
                   "ajax": "{{ action('EvalFormController@getAllEval',['type'=>$type])}}",
                    ...
                    "columns": [
                        ...
                        { title: "First name", defaultContent: " ", data:'firstname',width:'90'}, // 1
                        { title: "Evaluator", defaultContent: " ", data:'headFname',width:'100',render:function(data,type,full,meta){
                          return data+' '+full.headLname+'<br/><small><strong>'+full.camp+'</strong></small>';
                        } }, 
                        
                        { title: "Period Covered" ,defaultContent: "<i>empty</i>", data:'type',width:'90', render:function(data,type,full,meta){
