             ...
             @if(!$fromNDY)
              ...
              <div class="box box-info" style="background: rgba(256, 256, 256, 0.6)">
                <div class="box-header with-border">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                       <h2 class="text-center text-primary"><span style="font-size: smaller;">{{$startToday->format('l M d, Y')}} <?php echo date('l M d, Y'); ?></span> <br/> <span id="clock" style="font-weight: bolder;"></span> <br/><span class="text-gray" style="font-size:0.8em;">(Asia/Manila)</span> </h2>
