...
@section('metatags')
  <title>@if(empty($user->nickname) || $user->nickname==" ") {{$user->firstname}}'s @else {{$user->nickname}}'s @endif {{$vl->leaveType}}</title>
...
<section class="content-header">
      ...
      <h1><i class="{{$icon}} "></i> {{$leave}} <small></small>
      </h1>
      <ol class="breadcrumb">
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-lg-10 col-sm-12">
                                             ...
                                             @endif
                                              ...
                                              <table class="table">
                                                 {{ Form::open(['route' => ['user_fl.process'], 'method'=>'post','class'=>'col-lg-12', 'id'=> 'editVL' ]) }}
                                                <tr>
    ...
    $('.updateCWS').on('click', function(e)
    {
      ...
      $.ajax({
                ...
                success: function(response)
                {
                  ...
                  $('.table').fadeOut();
                  $.notify("{{$leave}}  updated.",{className:"success", globalPosition:'right middle',autoHideDelay:3000, clickToHide:true} );
