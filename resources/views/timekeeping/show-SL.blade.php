...
@section('metatags')
  <title>{{$user->firstname}}'s SL</title>
...
<section class="content-header">
      ...
      <h1><i class="fa fa-stethoscope"></i> Sick Leave <small></small>
      </h1>
      <ol class="breadcrumb">
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-lg-10 col-sm-12">
                                             ...
                                             @endif
                                              ...
                                              <table class="table">
                                                 {{ Form::open(['route' => ['user_sl.process'], 'method'=>'post','class'=>'col-lg-12', 'id'=> 'editVL' ]) }}
                                                <tr>
    ...
    $('.updateCWS').on('click', function(e)
    {
      ...
      $.ajax({
                ...
                success: function(response)
                {
                  ...
                  $('.table').fadeOut();
                  $.notify("Sick leave updated.",{className:"success", globalPosition:'right middle',autoHideDelay:3000, clickToHide:true} );
