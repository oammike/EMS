...
@section('metatags')
<title>Finance Default Work Sched Reports | Open Access EMS</title>
          ...
          <div class="row">
            ...
            <div class="col-lg-10" style="background: rgba(255, 255, 255, 0.4);"><BR/><BR/>
              ...
              <br/><br/>
                ...
                <input type="hidden" name="reportType" id="reportType" value="sched" />
              ...
              <div class="notes">
                <h4>There are <strong><span class="text-danger" id="submitted"></span> out of <span class="text-primary" id="total"> team members</span> </strong> under <span id="programName" style="font-style: italic;"></span>   who have plotted work schedules for that cutoff period.<br/> 

               <!--  </h4>

                  <p>Please remind the following employees to have their DTR sheets locked and verified for this cutoff period:</p> -->

                <span style="font-size: smaller;"> Proceed with the CSV download?</span></h4>
