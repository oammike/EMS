...
<section class="content-header">
      ...
      <h1><i class="fa fa-plane"></i> Vacation Leave <small></small>
      </h1>
      <ol class="breadcrumb">
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-lg-10 col-sm-12">
                                              ...
                                              <h4><i class="fa fa-plane"></i> Vacation Leave<br/><br/><br/></h4>
    ...
    $('.updateCWS').on('click', function(e)
    {
      ...
      $.ajax({
                ...
                success: function(response)
                {
                  ...
                  $('.table').fadeOut();
                  $.notify("Vacation leave updated.",{className:"success", globalPosition:'right middle',autoHideDelay:3000, clickToHide:true} );
