      ...
      <div class="row">
        <div class="col-xs-12" style="background: rgba(256, 256, 256, 0.5)">
           {{Form::open(['route' => 'biometrics.uploadSched','class'=>'col-lg-12', 'id'=>'uploadBio5', 'name'=>'uploadBio5', 'files'=>'true' ])}}<br/><br/>
                  ...
                  <div id="done"><h3 class="text-success"><i class="fa fa-calendar"></i> <strong>{{$total}}</strong> Employee Schedules <span style="font-size: smaller;"><br/>uploaded successfully.</span></h3> </div>
                  <div id="wait" style="display: none;"><h3 class="text-primary"><i class="fa fa-calendar"></i> Uploading and processing work schedules. <br/><span style="font-size: smaller;"><br/>Please wait...<img src="../public/css/img/loadingspin.gif" /></span></h3> </div>
