...
@section('metatags')
  <title>Upload ECQ Work Status</title>
...
<section class="content-header">
      ...
      <h1>Upload ECQ Work Status<small></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ action('HomeController@index') }}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        
        <li class="active">Upload ECQ Work Status</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12" style="background: rgba(256, 256, 256, 0.5)">
           {{Form::open(['route' => 'biometrics.uploadECQ','class'=>'col-lg-12', 'id'=>'uploadBio5', 'name'=>'uploadBio5', 'files'=>'true' ])}}<br/><br/>
                  ...
                  <div id="wait" style="display: none;" ><h3 class="text-primary"><i class="fa fa-calendar"></i> Uploading and processing ECQ work statuses. <br/><span style="font-size: 0.7em;"><br/>This could take a while depending on the number of employee schedules.<br/>Please wait...<img src="./public/css/img/loadingspin.gif" /></span></h3> </div>
