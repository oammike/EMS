...
@section('metatags')
  <title>{{$user->firstname}}'s VTO</title>
...
<section class="content-header">
      ...
      <h1><i class="fa fa-history"></i> Voluntary Time Off <small></small>
      </h1>
      <ol class="breadcrumb">
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-lg-10 col-sm-12">
                                              ...
                                              <h4><i class="fa fa-history"></i> VTO Details<br/><br/><br/></h4>

                                              <table class="table">
                                                 {{ Form::open(['route' => ['user_vl.process'], 'method'=>'post','class'=>'col-lg-12', 'id'=> 'editVL' ]) }}
                                                <tr>
    ...
    $('.updateCWS').on('click', function(e)
    {
      ...
      $.ajax({
                ...
                success: function(response)
                {
                  ...
                  $('.table').fadeOut();
                  $.notify("Voluntary Time Off updated.",{className:"success", globalPosition:'right middle',autoHideDelay:3000, clickToHide:true} );
