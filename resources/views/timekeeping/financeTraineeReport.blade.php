         ...
         // get validated dtr
          ...
          $.ajax({
                    ...
                    success: function(response){
                      ...
                      var htmltags="<tr><th>Trainee</th><th>Trainer</th><th class='text-right'>Total Hours</th><th>Total Allowance</th><th></th></tr>";// "<tr>";
                      var i=0;
                      ...
                      if (rdata.length > 1)
                      {
                        ...
                        for(var i = 0; i < rdata.length;  i++)//members.length;
                        {
                          ...
                          htmltags += "<td class='text-right'> Php "+ (rdata[i]['workedHours']/8)*rdata[i]['rate'] +"</td>";
