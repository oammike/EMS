                                                  ...
                                                  <tbody style="font-family: 'Source Sans Pro','Helvetica Neue',Helvetica,Arial,sans-serif; font-size:0.9em">
                                                    ...
                                                    @else
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td class="text-center"><a title="Onsite" class="btn btn-xs btn-default" href="{{action('LogsController@viewRawBiometricsData', $user->id)}}#{{$data['biometrics_id']}}" target="_blank"><i class="fa fa-building"></i> {{ date('l',strtotime($data->productionDate)) }} </a></td>
                                                        @endif
