...
<p>New Health Form Declaration Alert from: <strong> @if(is_null($employee->nickname)) {{$employee->firstname}} @else {{$employee->nickname}} @endif {{$employee->lastname}} </strong> <br/><br/>
   ...
   ------------------------------------------------------------<br/>
	...
	Our Nurses will advise you if{{$employee->firstname}} is cleared to return to work in the office. 
