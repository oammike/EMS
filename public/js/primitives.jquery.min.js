/*
 jQuery Widgets for Basic Primitives Diagrams v5.4.0
...
*/
primitives.common.jQueryButtonsTemplate=function(){var a,b=jQuery("<ul></ul>");b.css({position:"absolute",'list-style-type':"none"}).addClass("ui-widget ui-helper-clearfix");a=b.wrap("<div>").parent().html();var c=primitives.common.hashCode(a);return{template:function(){return a},getHashCode:function(){return c},render:function(a,c){var b=jQuery(c.element),h=0,e,g=c.buttons,f,i,j;switch(c.renderingMode){case primitives.common.RenderingMode.Create:for(j=0;j<g.length;j+=1)e=g[j],i=jQuery('<li data-buttonname="'+e.name+'"></li>').css({position:"absolute",
