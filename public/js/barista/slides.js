...
*/
  ...
  $('[data-slider-action]').click(function(){
    ...
    if ($(this).data('slider-id')){
      ...
      constructLabels($desiredElement);
  ...
  function constructLabels(element){
    var title = $(element).data('title'),
        desc = $(element).data('desc'),
        cost = $(element).data('cost'),
        id = $(element).data('id');

    $('#coffee_menu_title').text(title);
    $('#coffee_menu_desc').text(desc);
    $('#coffee_menu_cost').text(cost);
    window.order_id = id;
